...
from worktree_root import _resolve_worktree_main_checkout  # noqa: F401 -- POLY-49 ruling §3: moved to worktree_root.py, re-exported here so `run_tests._resolve_worktree_main_checkout` stays valid
